...
<html>
    ...
    <body >
        ...
        <div class="m-top8">
            ...
            <div class="container">
                <p>Este es nuestro menú de pizzas con grandes descuento. Que esperas consulta los precios, ofertas y las pizzas disponibles.</p>
                <div class="row">
        ...
        function fnAgregarCarrito(id, indice) {
            ...
            axios
                    ...
                    .then((response) => {
                        ...
                        if (response.msg === 'OK') {
                            fnSuccess("Pizza agregado al carrito!");
