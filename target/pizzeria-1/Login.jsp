                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-10">
                        <div class="wrap d-md-flex">
                            <div class="img" style="background-image: url(assets/img/ceviche.webp);">
                            </div>
                            <div class="  login-wrap p-4 p-md-5">
                                ...
                                <form method="post" action="Auth" class="signin-form">
                                    <div class="form-group mb-3">
                                        ...
                                        <input value="admin@gmail.com"  class="form-control form-control-lg" type="email" name="correo"  required=""/>
                                    </div>
                                    <div class="form-group mb-3">
