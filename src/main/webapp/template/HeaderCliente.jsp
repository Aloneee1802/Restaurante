...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" > <!-- navbar-petjoy -->
    <div class="container-fluid" >
        ...
        <a class="navbar-brand" href="index.jsp">
            <span class="flaticon-pizza-1 mr-1"></span>Pepito's<br><small>Restaurante</small>
        </a>
        ...
        <div class="collapse navbar-collapse  " id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto" >
                ...
                <li class="nav-item"><a href="Menu?accion=listar" class="nav-link">Platos</a></li>
                <li class="nav-item"><a href="Menu?accion=promocion" class="nav-link">Promociones</a></li>
                <li class="nav-item">
                ...
                <c:if test="${sessionScope.usuario != null}">
                    <li class="nav-item">
                        <a  class="nav-link" aria-current="page" href="Venta?accion=historial"><i
                                class="bi bi-person-circle"></i> Mis Compras</a>
                    </li>
                </c:if>
